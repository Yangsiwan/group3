...
public class TicTac {
	...
	public static void tt() {
		...
		try {
			...
			Thread.sleep(1000);
			System.out.println("Player: Wait, what is this?");
			Thread.sleep(1000);
			System.out.println("Cashier: Ahhh, that is an old game called TicTacToe.");
			Thread.sleep(1000);
			System.out.println("Player: Can I buy this?");
			Thread.sleep(1000);
		...
		while(true) {
			...
			while(playerPositions.contains(playerPos) || cashierPositions.contains(playerPositions)) {
